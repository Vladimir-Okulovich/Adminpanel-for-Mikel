...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {},
  computed: (0,C_xampp_htdocs_Mikel_Adminpanel_for_Mikel_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__.default)({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapGetters)([])),
  mounted: function mounted() {
    var _this = this;

    this.competitionId = this.$route.params.competitionId;
    this.initHome(this.competitionId).then(function (res) {
      // console.log(res)
    ...
    [
      _c(
        ...
        [
          _c("b-img", {
            attrs: {
              src: "/storage/" + _vm.competition.logo,
              height: "127",
              alt: "logo"
            }
          }),
          ...
          _c(
            ...
            [
              _c(
                ...
                [_vm._v(_vm._s(_vm.competition.title))]
              ),
              _vm._v(" "),
              _c(
                "p",
                ...
                [_vm._v(_vm._s(_vm.competition.description))]
              ),
              _vm._v(" "),
              _c(
                "p",
                ...
                [
                  _vm._v(
                    "\n        Lekua, data eta ordua:\n        " +
                      _vm._s(_vm.competition.place) +
                      "\n        " +
                      _vm._s(_vm.competition.date) +
                      "\n        " +
                      _vm._s(_vm.competition.time) +
                      "\n      "
                  )
                ]
              ),
              ...
              _c(
                ...
                [_vm._v("Antolatzailea: " + _vm._s(_vm.competition.organizer))]
              )
            ]
          ),
          _vm._v(" "),
